...
class Inmueble extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('precioInmueble, destacadoInmueble, estadoInmueble, habitacionesInmueble, bañosInmuebles, garageInmueble, cocinaInmueble, superficieInmueble, Barrio_idBarrio, Usuario_id', 'numerical', 'integerOnly'=>true),
			array('tituloInmueble, descripcionInmueble, Inmueblecol', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idInmueble, tituloInmueble, descripcionInmueble, precioInmueble, destacadoInmueble, estadoInmueble, habitacionesInmueble, bañosInmuebles, garageInmueble, cocinaInmueble, superficieInmueble, Inmueblecol, Barrio_idBarrio, Usuario_id', 'safe', 'on'=>'search'),
		);
	}
