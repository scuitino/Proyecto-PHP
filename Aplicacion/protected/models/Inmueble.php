...
class Inmueble extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idInmueble, tituloInmueble, descripcionInmueble, precioInmueble, destacadoInmueble, estadoInmueble, habitacionesInmueble, bañosInmuebles, garageInmueble, cocinaInmueble, superficieInmueble, Barrio_idBarrio, Usuario_id', 'safe', 'on'=>'search'),
		);
	}
