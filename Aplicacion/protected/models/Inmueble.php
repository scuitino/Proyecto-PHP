 ...
 * @property Usuario $usuarioCiUsuario
 */
class Inmueble extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('Usuario_ciUsuario, Barrio_idBarrio', 'required'),
			array('precioInmueble, Usuario_ciUsuario, destacadoInmueble, estadoInmueble, habitacionesInmueble, bañosInmuebles, garageInmueble, cocinaInmueble, superficieInmueble, Barrio_idBarrio', 'numerical', 'integerOnly'=>true),
			array('tituloInmueble, descripcionInmueble, Inmueblecol', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idInmueble, tituloInmueble, descripcionInmueble, precioInmueble, Usuario_ciUsuario, destacadoInmueble, estadoInmueble, habitacionesInmueble, bañosInmuebles, garageInmueble, cocinaInmueble, superficieInmueble, Inmueblecol, Barrio_idBarrio', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'eventos' => array(self::HAS_MANY, 'Evento', 'Inmueble_idInmueble'),
			'imagens' => array(self::HAS_MANY, 'Imagen', 'Inmueble_idInmueble'),
			'barrioIdBarrio' => array(self::BELONGS_TO, 'Barrio', 'Barrio_idBarrio'),
			'usuarioCiUsuario' => array(self::BELONGS_TO, 'Usuario', 'Usuario_ciUsuario'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('Usuario_ciUsuario',$this->Usuario_ciUsuario);
		...
		$criteria->compare('bañosInmuebles',$this->bañosInmuebles);
		...
		$criteria->compare('Inmueblecol',$this->Inmueblecol,true);
